  ...
  if (!session) {
    return (
      <main className="min-h-screen lg:h-screen lg:max-h-screen bg-[#fafafd] text-gray-900 font-sans flex flex-col justify-between relative overflow-hidden">
        ...
        {/* Clean, Glassmorphism Login Modal */}
        {showLoginModal && (
          <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="max-w-md w-full bg-white/95 backdrop-blur-xl border border-gray-100 rounded-3xl p-8 shadow-2xl relative space-y-6 text-gray-900">

              {/* Modal Close Button */}
              <button
                onClick={() => setShowLoginModal(false)}
                className="absolute top-5 right-5 text-gray-400 hover:text-gray-900 p-1.5 rounded-full hover:bg-gray-100 transition"
              >
                <X className="w-5 h-5" />
              </button>

              <div className="flex flex-col items-center text-center space-y-3 pt-2">
                <img src="/logo.png" alt="Broker Assistant Logo" className="h-12 w-auto object-contain mb-1" />
                <h2 className="text-2xl font-bold text-gray-950 tracking-tight">Login Broker Portal</h2>
                <p className="text-sm text-gray-600 leading-relaxed">
                  Sign in to manage your property database and dispatch bulk WhatsApp outreach.
                </p>
              </div>
              ...
              <div className="space-y-4 pt-1">
                <button
                  ...
                  className="w-full bg-gray-950 hover:bg-black text-white font-semibold py-3.5 px-4 rounded-2xl text-sm flex items-center justify-center gap-3 transition shadow-lg hover:shadow-xl cursor-pointer group"
                >
                ...
                <p className="text-[11px] text-gray-500 text-center leading-relaxed">
                  100% Private Workspace. Your contacts and WhatsApp logs are strictly isolated to your brokerage account.
                </p>
              </div>
